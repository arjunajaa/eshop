...
class PaymentServiceImplTest {
    ...
    void setUp() {
        ...
        Map<String, String> paymentData2 = Map.of("address", "Jalan Pondok Sofura", "deliveryFee", "25000");
    ...
    void testAddPayment() {
        ...
        Payment result = paymentService.addPayment(order, PaymentMethod.VOUCHER_CODE.getValue(),
